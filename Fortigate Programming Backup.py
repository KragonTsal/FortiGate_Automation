...
log_file = f'{string_hostname}-{date_time}.log'
...
with open('vips.csv', 'r') as read_obj:
...
for x in range(len(list_of_rows)):
    ...
    string_config_vip_line_3 = 'set extip ' + list_of_rows[x][1]
    ...
    config_vip.insert(2, string_config_vip_line_3)
    config_vip.insert(3, string_config_vip_line_4)
    config_vip.insert(4, string_config_vip_line_5)
    config_vip.insert(6, string_config_vip_line_7)
    config_vip.insert(7, string_config_vip_line_8)
    config_vip.insert(8, string_config_vip_line_9)
...
string_config_vip_grp_line_4 = 'set member ' + string_addr_grp_2

config_addr_grp.insert(1, string_config_vip_grp_line_2)
config_addr_grp.insert(3, string_config_vip_grp_line_4)
